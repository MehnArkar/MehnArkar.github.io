...
class CustomDesktopNavBar extends StatelessWidget {
  const CustomDesktopNavBar({super.key});
    ...
    return ClipRRect(
      child: BackdropFilter(
        ...
        child: Container(
          ...
          padding: const EdgeInsets.symmetric(horizontal: DesktopDimension.defaultPagePadding,vertical: DesktopDimension.defaultPagePadding/2),
