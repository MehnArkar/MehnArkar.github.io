...
class _NavBarItemState extends State<NavBarItem> {
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<NavBarCubit,NavBarType>(
      builder: (context,type) {
        bool isSelected = type == widget.type;
        return InkWell(
              ...
              children: [
                AnimatedContainer(
                  ...
                  decoration: BoxDecoration(
                      border: Border(bottom: BorderSide(color:isSelected ? context.colorScheme.primary : context.colorScheme.primary.withOpacity(0), width: 2))),
