...
class PlayStoreButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return OutlinedButton(
        ...
        child: Row(
          children: [
            Image.asset("${AppConstants.imagePath}/playstore.png",width: 18),
            ...
            Column(
              ...
              children: [
                ...
                Text("Google Play",style: context.textTheme.bodyMedium?.copyWith(fontWeight: FontWeight.w700,height: 0.9)),
              ],
            )
